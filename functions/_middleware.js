export const onRequest = async ({ request, next, env }) => {
  ...
  if (
    ...
    response.headers.set(
      ...
      `default-src 'self'; base-uri 'none'; object-src 'none'; connect-src https://sentry.io/ https://gateway.umami.is https://analytics.umami.is/ https://contactform.continuumdesign.net/; frame-src https://challenges.cloudflare.com; img-src 'self' data; style-src 'self'; script-src 'strict-dynamic' 'nonce-${NONCE_TOKEN}'; frame-ancestors 'none'; require-trusted-types-for 'script'; report-uri https://o1405800.ingest.sentry.io/api/6739194/security/?sentry_key=3e24862ff9ce4761ab71fce722fc4c6b;`
    );
